...
App-specific documentation is in [`frigatespotter/DOCS.md`](frigatespotter/DOCS.md).

The Home Assistant App is locally buildable by Supervisor, so installing it from this repository does not require a separately published container image.
